...
public class BankQrService {
    ...
    public static class BankQrResult {
        private String transferCode;   // vd "GYMPRO6"
        private String content;        // nội dung đầy đủ nhúng trong QR, vd "GYMPRO6"
        private String qrRawPayload;   // chuỗi VietQR chuẩn EMVCo để FE tự render QR
        private String qrImageUrl;     // link ảnh QR dự phòng (nếu FE muốn dùng thay vì tự render)
    }
